...
class AdminPage(BasePage):
    ...
    def __init__(self, driver, **kwargs):
        ...
        logging.debug("Called AdminPage.__init__()")
        ...
        if self.driver.current_url == login_url and self.SKIP_LOGIN is True:
            ...
            logging.debug("Navigating to {}".format(self.URL))
            self.go_to_page_url()
        else:
            logging.debug("Already at {}".format(self.URL))
